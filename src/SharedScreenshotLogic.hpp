...
namespace SharedScreenshotLogic {
	...
	void findSorkosShaderNodesAndScaleThemToSixSeven(CCNode* node, std::unordered_map<CCNode*, CCSize>& sorkosShaderNodesAndTheirContentSizes, bool& screenshotterIsSelf);
